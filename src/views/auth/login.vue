    ...
    <div class="d-flex" style="height: 100%">
      <div class="bluebackground" style="color: black;">
        ...
        <div class="mx-auto" style=" width: 75%;padding-top: 90px">
          <span style="font-size: 29px; color: #000; font-weight: bold;">Hospital Sign In</span>
      ...
      <div style=" width: 60%; background-color: #FAFAFA;height: 100%">
        ...
        <div class="d-flex align-center" style=" height: 80%">
          <img src="../../assets/Group.png" width="400" class="mx-auto d-flex align-center" />
        </div>
      </div>
    </div>
  </v-app>
    ...
    register() {
      ...
      auth
        ...
        .then(result => {
          ...
          database.ref('hospitals').child(result.user.uid)
        })
        .finally(() => {
          this.loader = false;
        });
